...
INSERT INTO `menu` (`id`, `Activo`, `Nombre`, `Ruta`) VALUES (1,1,'Informacion','/Application/Informacionalumno'),(2,1,'Carrera','/Application/Resultadoconsulta'),(3,1,'Tienda','/Application/index'),(4,1,'Inscripciones','/Application/Alumnos');
