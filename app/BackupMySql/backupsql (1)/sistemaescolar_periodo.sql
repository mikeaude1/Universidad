...
CREATE TABLE `periodo` (
  ...
  `FrchaFin` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `periodo` (`id`, `Activo`, `Nombre`, `FechaInicio`, `FechaFin`, `FrchaFin`) VALUES (1,'1','Mayo-Agosto','2023-05-01','2023-08-31',NULL),(2,'1','Enero-Abril','2023-01-01','2023-04-30',NULL);
