...
CREATE TABLE `perfiles` (
  ...
  `Nombreperfil` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `perfiles` (`id`, `Activo`, `Nivelacceso`, `Nombreperfil`) VALUES (1,_binary '',1,'Alumno'),(2,_binary '',2,'Profesor'),(3,_binary '',3,'Administrador'),(4,_binary '',4,'Administrador General');
